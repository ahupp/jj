...
fn test_git_export_undo() {
    ...
    insta::assert_snapshot!(output, @"
    ------- stderr -------
    Restored to operation: f2356633e982 (2001-02-03 08:05:08) create bookmark a pointing to commit e8849ae12c709f2321908879bc724fdb2ab8a781
    [EOF]
    ");
...
fn test_git_import_undo() {
    ...
    insta::assert_snapshot!(output, @"
    ------- stderr -------
    Restored to operation: f045ea2142cf (2001-02-03 08:05:07) add workspace 'default'
    [EOF]
    ");
    insta::assert_snapshot!(get_bookmark_output(&work_dir), @"");
