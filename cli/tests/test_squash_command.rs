...
fn test_squash_to_new_commit() {
    ...
    ├─╮  file 3&4
    │ │  -- operation 870d1506b06a squash commit 0d254956d33ed5bb11d93eb795c5e514aadc81b5 and 1 more
    ...
    │ │  file4
    │ │  -- operation ef3f3e2c40e6 commit 89a30a7539466ed176c1ef122a020fd9cb15848e
    │ ○  zsuskuln/5 test.user@example.com 2001-02-03 08:05:11 89a30a75 (hidden)
    │ │  (no description set)
    │ │  -- operation 294ee0ba072a snapshot working copy
    │ ○  zsuskuln/6 test.user@example.com 2001-02-03 08:05:10 bbf04d26 (hidden)
    │    (empty) (no description set)
    │    -- operation deee79b5ebc1 commit c23c424826221bc4fdee9487926595324e50ee95
    ...
    │  (no description set)
    │  -- operation 9a6d90136180 snapshot working copy
    ○  kkmpptxz/5 test.user@example.com 2001-02-03 08:05:09 c1272e87 (hidden)
       (empty) (no description set)
       -- operation 4d3d6b6d8a8b commit cb58ff1c6f1af92f827661e7275941ceb4d910c5
    [EOF]
    ");
    ...
    ○  nsrwusvy test.user@example.com 2001-02-03 08:05:42 c2183685
       (empty) (no description set)
       -- operation 69aafc4d8fbb squash 0 commits
    [EOF]
    ");
    ...
    ○  wtlqussy test.user@example.com 2001-02-03 08:05:46 7eff41c8
       (empty) (no description set)
       -- operation faf4dc5c6386 squash commit 0d254956d33ed5bb11d93eb795c5e514aadc81b5 and 1 more
    [EOF]
    ");
    ...
    │  (empty) (no description set)
    │  -- operation b7a19cd58346 squash commit f5e47d019271a392eb7f92a6b2e9f8cf41d97049
    ○  szrrkvty/0 test.user@example.com 2001-02-03 08:05:50 f5e47d01 (hidden)
       (empty) (no description set)
       -- operation e4033700a012 new empty commit
    [EOF]
    ");
