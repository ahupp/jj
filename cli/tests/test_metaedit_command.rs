...
fn test_new_change_id() {
    ...
    │  (no description set)
    │  -- operation c68e34985e67 edit commit metadata for commit 75591b1896b4990e7695701fd7cdbb32dba3ff50
    ○  kkmpptxz/0 test.user@example.com 2001-02-03 08:05:11 75591b18 (hidden)
    │  (no description set)
    │  -- operation c57b2f92b2fd snapshot working copy
    ○  kkmpptxz/1 test.user@example.com 2001-02-03 08:05:09 acebf2bd (hidden)
       (empty) (no description set)
       -- operation 787575bbad0c new empty commit
    [EOF]
    ");
    ...
    │  (no description set)
    │  -- operation 48aa681d5f28 snapshot working copy
    ○  mzvwutvl/2 test.user@example.com 2001-02-03 08:05:11 b9f5490a (hidden)
       (empty) (no description set)
       -- operation 492c012f1295 new empty commit
    [EOF]
    ");
}
